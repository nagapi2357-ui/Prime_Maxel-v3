/*
 * Progressive Composite Addition #4 — Prime_Maxel-v3
 * EXPERIMENT: 4 composite frequencies active: f₀/4, f₀/6, f₀/8, f₀/9
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 4, 6, 8, 9, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== PROG COMP #4: f₀/4, f₀/6, f₀/8, f₀/9 ==="));
  for (uint8_t i = 0; i < NUM_CHANNELS; i++) {
