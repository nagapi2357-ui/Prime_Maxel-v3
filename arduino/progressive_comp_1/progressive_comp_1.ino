/*
 * Progressive Composite Addition #1 — Prime_Maxel-v3
 * EXPERIMENT: 1 composite frequency active: f₀/4
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 4, 0, 0, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== PROG COMP #1: f0/4 ==="));
  for (uint8_t i = 0; i < NUM_CHANNELS; i++) {
