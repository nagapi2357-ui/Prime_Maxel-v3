/*
 * Coprimality Dimensions — coprime_dim_D — Prime_Maxel-v3
 * Semiprimes {6,10,15} — 0% coprime
 *
 *   Pin 22: f₀/6 = 170.7 Hz (ACTIVE)
 *   Pin 24: f₀/10 = 102.4 Hz (ACTIVE)
 *   Pin 26: f₀/15 = 68.3 Hz (ACTIVE)
 *   Pin 28: OFF
 *   Pin 30: OFF
 *   Pin 32: OFF
 */
...
const uint8_t divisors[NUM_CHANNELS] = { 6, 10, 15, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== coprime_dim_D: f₀/6, f₀/10, f₀/15 ==="));
  for (uint8_t i = 0; i < NUM_CHANNELS; i++) {
