/*
 * Progressive Addition #3 — Prime_Maxel-v3
 * EXPERIMENT: 3 prime frequency/ies active: f₀/1, f₀/3, f₀/5
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 1, 3, 5, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== PROGRESSIVE #3: f₀/1, f₀/3, f₀/5 ==="));
