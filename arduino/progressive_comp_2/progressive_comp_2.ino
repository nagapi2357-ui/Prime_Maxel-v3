/*
 * Progressive Composite Addition #2 — Prime_Maxel-v3
 * EXPERIMENT: 2 composite frequencies active: f₀/4, f₀/6
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 4, 6, 0, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== PROG COMP #2: f₀/4, f₀/6 ==="));
  for (uint8_t i = 0; i < NUM_CHANNELS; i++) {
