/*
 * Progressive Addition #4 — Prime_Maxel-v3
 * EXPERIMENT: 4 prime frequency/ies active: f₀/1, f₀/3, f₀/5, f₀/7
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 1, 3, 5, 7, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== PROGRESSIVE #4: f₀/1, f₀/3, f₀/5, f₀/7 ==="));
