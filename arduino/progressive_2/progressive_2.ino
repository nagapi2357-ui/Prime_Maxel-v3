/*
 * Progressive Addition #2 — Prime_Maxel-v3
 * EXPERIMENT: 2 prime frequency/ies active: f₀/1, f₀/3
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 1, 3, 0, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== PROGRESSIVE #2: f₀/1, f₀/3 ==="));
