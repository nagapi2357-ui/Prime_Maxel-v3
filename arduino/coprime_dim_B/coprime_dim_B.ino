/*
 * Coprimality Dimensions — coprime_dim_B — Prime_Maxel-v3
 * Squares {4,9,16} — 67% coprime (gcd(4,16)=4)
 *
 *   Pin 22: f₀/4 = 256.0 Hz (ACTIVE)
 *   Pin 24: f₀/9 = 113.8 Hz (ACTIVE)
 *   Pin 26: f₀/16 = 64.0 Hz (ACTIVE)
 *   Pin 28: OFF
 *   Pin 30: OFF
 *   Pin 32: OFF
 */
...
const uint8_t divisors[NUM_CHANNELS] = { 4, 9, 16, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== coprime_dim_B: f₀/4, f₀/9, f₀/16 ==="));
  for (uint8_t i = 0; i < NUM_CHANNELS; i++) {
