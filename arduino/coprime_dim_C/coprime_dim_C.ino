/*
 * Coprimality Dimensions — coprime_dim_C — Prime_Maxel-v3
 * Coprime squares+prime {4,9,7} — 100% coprime
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 4, 9, 7, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== coprime_dim_C: f₀/4, f₀/9, f₀/7 ==="));
  for (uint8_t i = 0; i < NUM_CHANNELS; i++) {
