/*
 * Progressive Composite Addition #3 — Prime_Maxel-v3
 * EXPERIMENT: 3 composite frequencies active: f₀/4, f₀/6, f₀/8
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 4, 6, 8, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== PROG COMP #3: f₀/4, f₀/6, f₀/8 ==="));
  for (uint8_t i = 0; i < NUM_CHANNELS; i++) {
