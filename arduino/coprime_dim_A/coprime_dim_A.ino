/*
 * Coprimality Dimensions — coprime_dim_A — Prime_Maxel-v3
 * Pure primes {3,5,7} — 100% coprime
 *
 *   Pin 22: f₀/3 = 341.3 Hz (ACTIVE)
...
const uint8_t divisors[NUM_CHANNELS] = { 3, 5, 7, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== coprime_dim_A: f₀/3, f₀/5, f₀/7 ==="));
  for (uint8_t i = 0; i < NUM_CHANNELS; i++) {
