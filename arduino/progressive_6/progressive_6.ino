/*
 * Progressive Addition #6 — Prime_Maxel-v3
 * EXPERIMENT: 6 prime frequency/ies active: f₀/1, f₀/3, f₀/5, f₀/7, f₀/11, f₀/13
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 1, 3, 5, 7, 11, 13 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== PROGRESSIVE #6: f₀/1, f₀/3, f₀/5, f₀/7, f₀/11, f₀/13 ==="));
