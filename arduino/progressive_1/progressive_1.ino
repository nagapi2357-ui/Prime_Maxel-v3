/*
 * Progressive Addition #1 — Prime_Maxel-v3
 * EXPERIMENT: 1 prime frequency/ies active: f₀/1
 *
...
const uint8_t divisors[NUM_CHANNELS] = { 1, 0, 0, 0, 0, 0 };
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("=== PROGRESSIVE #1: f₀/1 ==="));
